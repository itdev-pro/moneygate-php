...
class BalanceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->right_auth = new Auth($privateKey, '123');
        $this->right_balance = new Balance($this->right_auth, $_ENV['Token']);
        
        $privateKey = file_get_contents('/home/homi/my_projects/SDK_Moneygate_API/tests/Balance/wrong.key');
        $this->wrong_auth = new Auth($privateKey, '123');
        $this->wrong_balance = new Balance($this->wrong_auth, $_ENV['Token']);
